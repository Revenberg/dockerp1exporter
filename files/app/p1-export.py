    ...
    def __init__(self, PROMETHEUS_PREFIX='', pool_frequency=5, device='/dev/ttyUSB0', baudrate=115200):
        ...
        for record in self.meter._datadetails: 
            ...
            if self.meter._datadetails[record]['prometheus'] == "Info":
                self.prometheus[self.meter._datadetails[record][record]] = Info(PROMETHEUS_PREFIX + self.meter._datadetails[record]['prometheus'], self.meter._datadetails[record]['value'])
            if self.meter._datadetails[record]['prometheus'] == "Gauge":
                self.prometheus[self.meter._datadetails[record][record]] = Gauge(PROMETHEUS_PREFIX + self.meter._datadetails[record]['prometheus'], self.meter._datadetails[record]['value'])
